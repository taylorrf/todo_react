import {addTodo, findById, toogleTodo, updateTodo} from './TodoHelpers'
...
test("add Todo should not mutate the existing todo array", () => {
  const startTodos = [
    {id: 1, name: 'one', isComplete: false},
    {id: 2, name: 'two', isComplete: false}
  ]
...
test('toogleTodo should toggle the isComplete prop of a todo', () => {
